                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="relative">
                                ...
                                <input {...register("password")} aria-invalid={errors.email ? "true" : "false" } className="border border-purple-600 outline-none focus:ring-2 focus:ring-purple-300 aria-[invalid=true]:border-red-500 aria-[invalid=true]:ring-red-300 shadow-sm rounded-lg w-full pl-10 py-2" type="password" name="password" placeholder="password" />
                            </div>
