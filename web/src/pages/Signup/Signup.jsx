                ...
                <div className="bg-white flex flex-col gap-5 rounded px-6 py-8 h-auto w-96">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="name" className="border border-blue-500 rounded px-2 py-1" />
                        </div>
                        <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="file" name="email" id="email" className="border border-blue-500 rounded px-2 py-1" />
                        </div>
                    </div>
                    <button className="bg-blue-600 rounded text-white py-2 mt-3">Signup</button>
                </div>
            </main>
            <Footer />
        </div>
